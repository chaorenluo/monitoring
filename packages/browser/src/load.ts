...
import { htmlElementAsString, Severity } from '@monitoring/utils'
import { EVENTTYPES, BREADCRUMBTYPES } from '@monitoring/shared'
import { breadcrumb, handleConsole } from '@monitoring/core'
