...
import { transportData, options, setTraceId, triggerHandlers, ReplaceHandler, subscribeEvent } from '@monitoring/core'
import { EMethods, MITOHttp, MITOXMLHttpRequest } from '@monitoring/types'
import { voidFun, EVENTTYPES, HTTPTYPE, HTTP_CODE } from '@monitoring/shared'
...
function fetchReplace():void{
    ...
    replaceOld(_global,EVENTTYPES.FETCH,(originalFetch: voidFun): voidFun => {
        // @ts-ignore
